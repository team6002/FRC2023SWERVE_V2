...
public class SwerveDrivetrain extends SubsystemBase {
  ...
  private final SwerveModule m_frontLeft = 
    new SwerveModule(
      ...
      DriveConstants.k_frontLeftOffset,
      1);
  private final SwerveModule m_frontRight = 
    new SwerveModule(
        ...
        DriveConstants.k_frontRightOffset,
        2);
  private final SwerveModule m_BackLeft = 
    new SwerveModule(
        ...
        DriveConstants.kBackLeftDriveAnalogPort,
        DriveConstants.k_backLeftOffset,
        3);
  private final SwerveModule m_BackRight = 
    new SwerveModule(
        ...
        DriveConstants.kBackRightDriveAnalogPort,
        DriveConstants.k_backLeftOffset,
        4
        );
  ...
  public void resetOdometry(Pose2d pose) {
    m_odometry.resetPosition( m_Navx.getRotation2d(), m_modulePosition,pose);
  }
